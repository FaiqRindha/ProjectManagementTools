...
<body>
    <div style="background: linear-gradient(135deg, #ebebeb, #f6f6f6);">
        <div class="flex">
            ...
            <div class="" style="height: 100vh; width: 84vw; padding: 24px;">
                <div class="flex">
                    <div>
                        <div class="rounded-sm shadow-xl" style="height: 35vh; width: 50vw; background-color: #ffffff; padding: 15px">
                            <div class="text-center font-bold" style="height: 1vh">
                                DIVISION PROJECT
                            </div>
                            <div class="flex gap-20 justify-center" style="height: 32vh">
                                <div class="my-auto overflow-hidden">
                                    <div class="h-24 p-2 w-24 my-auto" style="background-color: #ff8367">
                                        <div style="word-wrap: break-word;" class="mt-3 text-center font-bold text-3xl">
                                            1
                                        </div>
                                    </div>
                                ...
                                <div class="my-auto overflow-hidden">
                                    <div class="h-24 p-2 w-24 my-auto" style="background-color: rgb(254, 238, 130)">
                                        <div style="word-wrap: break-word;" class="mt-3 text-center font-bold text-3xl">
                                            2
                                        </div>
                                    </div>
                                ...
                                <div class="my-auto overflow-hidden">
                                    <div class="h-24 p-2 w-24 my-auto" style="background-color: chartreuse">
                                        <div style="word-wrap: break-word;" class="mt-3 text-center font-bold text-3xl">
                                            3
                                        </div>
                                    </div>
                        ...
                        <div class="bg-white rounded-sm shadow-xl" style="height: 55vh; width: 50vw; margin-top: 1vw">
                            <div class="text-center font-bold" style="height: 1vh; padding: 15px">
                                ACTIVE PROJECT
                            </div>
                            <div class="mx-auto mt-7 text-center" style="width: 40vw">
                                <table style="width: 100%; border-collapse: collapse;">
                                    <!-- Table Body -->
                                    <tbody>
                                    <tr>
                                            <td class="text-sm font-semibold" style="border: 2px solid black; padding: 6px; width: 50%">PROJECT NAME</td>
                                            <td class="text-sm font-semibold" style="border: 2px solid black; padding: 6px; width: 25%">CREATED DATE</td>
                                            <td class="text-sm font-semibold" style="border: 2px solid black; padding: 6px; width: 25%">ESTIMATED TIMELINE</td>
                                        </tr>
                                    <tr>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 2, Column 1</td>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 2, olumn 2</td>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 2, olumn 3</td>
                                        </tr>
                                    <tr>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 3, Column 1</td>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 3, olumn 2</td>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 3, olumn 3</td>
                                        </tr>
                                    <tr>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 4, Column 1</td>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 4, olumn 2</td>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 4, olumn 3</td>
                                        </tr>
                                    <tr>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 5, Column 1</td>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 5, olumn 2</td>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 5, olumn 3</td>
                                        </tr>
                                    <tr>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 6, Column 1</td>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 6, olumn 2</td>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 6, olumn 3</td>
                                        </tr>
                                    <tr>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 7, Column 1</td>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 7, olumn 2</td>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 7, olumn 3</td>
                                        </tr>
                                    <tr>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 8, Column 1</td>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 8, olumn 2</td>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 8, olumn 3</td>
                                        </tr>
                                    <tr>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 9, Column 1</td>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 9, Column 2</td>
                                            <td class="text-sm" style="border: 2px solid black; padding: 6px; ">Row 9, Column 3</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="bg-white rounded-md shadow-xl" style="height: 92vh; width: 30vw; margin-left: 1vw;">
                        <div class="text-center font-bold" style="height: 11vh; padding: 15px;">
                            ACTIVE PROJECT
                        </div>
                        <div class="mx-auto rounded-md py-1 px-2" style="height: 14vh; width: 55vh; background-color: #868584">
                            <div class="font-bold">
                                22/11/2024
                            </div>
                        </div>
                        <div class="mx-auto rounded-md mt-4 py-1 px-2" style="height: 14vh; width: 55vh; background-color: #868584">
                            <div class="font-bold">
                                22/11/2024
                            </div>
                        </div>
